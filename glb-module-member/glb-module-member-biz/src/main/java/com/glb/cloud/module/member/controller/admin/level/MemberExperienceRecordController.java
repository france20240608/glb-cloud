package com.glb.cloud.module.member.controller.admin.level;

import com.glb.cloud.framework.common.pojo.CommonResult;
import com.glb.cloud.framework.common.pojo.PageResult;
import com.glb.cloud.module.member.controller.admin.level.vo.experience.MemberExperienceRecordPageReqVO;
import com.glb.cloud.module.member.controller.admin.level.vo.experience.MemberExperienceRecordRespVO;
import com.glb.cloud.module.member.convert.level.MemberExperienceRecordConvert;
import com.glb.cloud.module.member.dal.dataobject.level.MemberExperienceRecordDO;
import com.glb.cloud.module.member.service.level.MemberExperienceRecordService;
