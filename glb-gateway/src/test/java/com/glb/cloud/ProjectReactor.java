...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.glb.cloud";
    private static final String ARTIFACT_ID = "glb";
    private static final String PACKAGE_NAME = "com.glb.cloud";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.glb.cloud";
        String artifactIdNew = "glb";
        String packageNameNew = "com.glb.cloud";
