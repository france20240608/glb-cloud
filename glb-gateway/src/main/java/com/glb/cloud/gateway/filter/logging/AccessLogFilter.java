package com.glb.cloud.gateway.filter.logging;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 glb-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
        ...
        return new ServerHttpResponseDecorator(response) {
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    gatewayLog.setHttpStatus(HttpStatus.valueOf(response.getStatusCode().value()));
