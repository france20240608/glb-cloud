package com.glb.cloud.module.system.api.logger.dto;
...
public class OperateLogRespDTO implements VO {
    ...
    @Trans(type = TransType.RPC, targetClassName = "com.glb.cloud.module.system.dal.dataobject.user.AdminUserDO",
