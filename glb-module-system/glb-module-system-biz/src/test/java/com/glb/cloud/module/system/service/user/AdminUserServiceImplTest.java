package com.glb.cloud.module.system.service.user;
...
import com.glb.cloud.framework.common.util.collection.ArrayUtils;
...
import com.glb.cloud.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.glb.cloud.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.glb.cloud.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.glb.cloud.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.glb.cloud.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.glb.cloud.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import com.glb.cloud.module.system.dal.dataobject.dept.UserPostDO;
import com.glb.cloud.module.system.dal.dataobject.tenant.TenantDO;
import com.glb.cloud.module.system.dal.dataobject.user.AdminUserDO;
import com.glb.cloud.module.system.dal.mysql.dept.UserPostMapper;
import com.glb.cloud.module.system.dal.mysql.user.AdminUserMapper;
import com.glb.cloud.module.system.enums.common.SexEnum;
import com.glb.cloud.module.system.service.dept.DeptService;
import com.glb.cloud.module.system.service.dept.PostService;
import com.glb.cloud.module.system.service.permission.PermissionService;
...
import static com.glb.cloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.glb.cloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static com.glb.cloud.framework.test.core.util.RandomUtils.*;
import static com.glb.cloud.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("glbyuanma");
        ...
        assertEquals("glbyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("glbyuanma"))).thenReturn("java");
