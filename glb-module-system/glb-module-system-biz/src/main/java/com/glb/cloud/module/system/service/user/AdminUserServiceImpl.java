...
import com.glb.cloud.framework.datapermission.core.util.DataPermissionUtils;
...
import static com.glb.cloud.module.system.enums.LogRecordConstants.*;
...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Value("${sys.user.init-password:glbyuanma}")
