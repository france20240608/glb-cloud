package com.glb.cloud.module.report.framework.jmreport.core.service;
...
import com.glb.cloud.module.system.api.oauth2.dto.OAuth2AccessTokenCheckRespDTO;
...
public class JmReportTokenServiceImpl implements JmReportTokenServiceI {
    ...
    public HttpHeaders customApiHeader() {
        // 读取积木标标系统的 token
        HttpServletRequest request = JakartaServletUtils.getRequest();
