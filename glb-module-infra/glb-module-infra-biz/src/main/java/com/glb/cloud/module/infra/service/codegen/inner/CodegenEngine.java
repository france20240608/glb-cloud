package com.glb.cloud.module.infra.service.codegen.inner;
...
import com.glb.cloud.framework.apilog.core.enums.OperateTypeEnum;
import com.glb.cloud.framework.common.exception.util.ServiceExceptionUtil;
...
import com.glb.cloud.framework.excel.core.annotations.DictFormat;
import com.glb.cloud.framework.excel.core.convert.DictConvert;
import com.glb.cloud.framework.excel.core.util.ExcelUtils;
import com.glb.cloud.framework.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "glb-module-${table.moduleName}/" + // 顶级模块
                "glb-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "glb-module-${table.moduleName}/" + // 顶级模块
                "glb-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "glb-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "glb-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
