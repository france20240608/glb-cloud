package com.glb.cloud.module.bpm.controller.admin.definition.vo.process;
...
public class BpmProcessDefinitionRespVO {
    ...
    @Schema(description = "流程标识", requiredMode = Schema.RequiredMode.REQUIRED, example = "glb")
    private String key;

    @Schema(description = "流程图标", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.iocoder.cn/glb.jpg")
    private String icon;
