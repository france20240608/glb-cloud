package com.glb.cloud.framework.signature.core.aop;
...
import com.glb.cloud.framework.signature.core.annotation.ApiSignature;
import com.glb.cloud.framework.signature.core.redis.ApiSignatureRedisDAO;
...
public class ApiSignatureAspect {
    ...
    public void beforePointCut(JoinPoint joinPoint, ApiSignature signature) {
        // 1. 验证通过，直接结束
        if (verifySignature(signature, Objects.requireNonNull(JakartaServletUtils.getRequest()))) {
            return;
        }
    ...
    private String buildSignatureString(ApiSignature signature, HttpServletRequest request, String appSecret) {
        ...
        String requestBody = StrUtil.nullToDefault(JakartaServletUtils.getBody(request), ""); // 请求体
