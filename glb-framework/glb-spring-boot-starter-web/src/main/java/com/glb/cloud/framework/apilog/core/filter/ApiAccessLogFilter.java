package com.glb.cloud.framework.apilog.core.filter;
...
import com.glb.cloud.framework.web.core.filter.ApiRequestFilter;
import com.glb.cloud.framework.web.core.util.WebFrameworkUtils;
import com.glb.cloud.module.infra.api.logger.dto.ApiAccessLogCreateReqDTO;
...
import static com.glb.cloud.framework.apilog.core.interceptor.ApiAccessLogInterceptor.*;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        Map<String, String> queryString = JakartaServletUtils.getParamMap(request);
        String requestBody = JakartaServletUtils.isJsonRequest(request) ? JakartaServletUtils.getBody(request) : null;
    ...
    private boolean buildApiAccessLog(ApiAccessLogCreateReqDTO accessLog, HttpServletRequest request, LocalDateTime beginTime,
        ...
        accessLog.setTraceId(TracerUtils.getTraceId()).setApplicationName(applicationName)
                ...
                .setUserAgent(JakartaServletUtils.getUserAgent(request)).setUserIp(JakartaServletUtils.getClientIP(request));
