package com.glb.cloud.framework.xss.core.json;

import com.glb.cloud.framework.common.util.servlet.JakartaServletUtils;
import com.glb.cloud.framework.xss.config.XssProperties;
...
public class XssStringJsonDeserializer extends StringDeserializer {
    ...
    public String deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (request != null) {
            String uri = JakartaServletUtils.getRequest().getRequestURI();
