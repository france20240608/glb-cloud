package com.glb.cloud.framework.tracer.config;

import com.glb.cloud.framework.common.enums.WebFilterOrderEnum;
import com.glb.cloud.framework.tracer.core.aop.BizTraceAspect;
import com.glb.cloud.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "glb.tracer", value = "enable", matchIfMissing = true)
public class GlbTracerAutoConfiguration {
