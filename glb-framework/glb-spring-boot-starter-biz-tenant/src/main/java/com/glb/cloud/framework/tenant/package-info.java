 ...
 *      1）Spring Async：
 *          {@link com.glb.cloud.framework.quartz.config.GlbAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 GlbSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.glb.cloud.framework.tenant;
