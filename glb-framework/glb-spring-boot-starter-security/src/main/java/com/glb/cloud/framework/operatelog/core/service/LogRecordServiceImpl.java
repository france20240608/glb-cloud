package com.glb.cloud.framework.operatelog.core.service;
...
public class LogRecordServiceImpl implements ILogRecordService {
    ...
    private static void fillRequestFields(OperateLogCreateReqDTO reqDTO) {
        ...
        reqDTO.setUserIp(JakartaServletUtils.getClientIP(request));
        reqDTO.setUserAgent(JakartaServletUtils.getUserAgent(request));
    }
